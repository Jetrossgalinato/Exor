...
export function Footer() {
  ...
  return (
    <footer className="w-full relative overflow-hidden border-t border-border/50 bg-muted/40">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16 pb-6 sm:pb-10 flex flex-col gap-6 sm:gap-12">
        {/* Main grid */}
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
          {/* Brand */}
          <div className="flex flex-col gap-2.5 sm:gap-4 col-span-2 lg:col-span-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mt-1">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <Link
                  ...
                  aria-label={label}
                  className="flex items-center justify-center w-7 h-7 sm:w-9 sm:h-9 rounded-xl border border-border bg-card shadow-[0_1px_2px_rgba(0,0,0,0.06),0_2px_6px_rgba(0,0,0,0.06)] hover:shadow-[0_2px_8px_rgba(0,0,0,0.12)] hover:border-border/80 transition-all duration-200 text-muted-foreground hover:text-foreground"
                >
          ...
          <div className="flex flex-col gap-2.5 sm:gap-4">
            ...
            <ul className="flex flex-col gap-2 sm:gap-3">
              <li className="flex items-start gap-1.5 sm:gap-2.5 text-xs sm:text-sm text-muted-foreground">
                <MapPin className="w-3 h-3 sm:w-4 sm:h-4 shrink-0 mt-0.5 text-primary" />
                <span>
                  Hiraya Bldg. CSU Main Campus Ampayon, Butuan City, 8600
                </span>
              </li>
              <li className="flex items-center gap-1.5 sm:gap-2.5 text-xs sm:text-sm text-muted-foreground">
                <Mail className="w-3 h-3 sm:w-4 sm:h-4 shrink-0 text-primary" />
                <a
              ...
              <li className="flex items-center gap-1.5 sm:gap-2.5 text-xs sm:text-sm text-muted-foreground">
                <Phone className="w-3 h-3 sm:w-4 sm:h-4 shrink-0 text-primary" />
                <a
        ...
        {/* Bottom bar */}
        <div className="relative flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3 pt-5 sm:pt-8">

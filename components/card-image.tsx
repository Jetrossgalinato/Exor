...
export function CardImage({
  ...
  return (
    <Card className="relative group mx-auto w-full h-full pt-0 overflow-hidden transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] dark:hover:shadow-primary/5 border-border/40">
